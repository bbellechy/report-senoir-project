...
\cite{medicine2018} การจัดการระบบยาเป็นสิ่งสำคัญอย่างยิ่งที่เกี่ยวข้องกับความปลอดภัยของผู้ป่วยหรือผู้ใช้บริการในโรงพยาบาล ระบบยาที่ครอบคลุมสะท้อนให้เห็นถึงการทำงานร่วมกันของทีมสหสาขาวิชาชีพ เพื่อให้การบริหารจัดการระบบยาในโรงพยาบาลมีประสิทธิภาพและปลอดภัย
...
\cite{database2022} การออกแบบฐานข้อมูลที่ดีมีความสำคัญอย่างยิ่งต่อความถูกต้องและความสมบูรณ์ของข้อมูล และช่วยให้สามารถเรียกใช้หรือปรับปรุงข้อมูลได้อย่างมีประสิทธิภาพ โดยหลักการออกแบบฐานข้อมูลที่ดี มีดังนี้
\begin{enumerate}[leftmargin=2em]
...
\label{sec:ocr}
\cite{ocr2025} หรือที่รู้จักกันในภาษาไทยคือ "การรู้จำอักขระด้วยแสง" คือเทคโนโลยีที่ใช้ในการแปลงข้อความจากรูปแบบภาพ (เช่น รูปถ่าย, ภาพสแกน, ไฟล์ PDF ที่เป็นภาพ) ให้กลายเป็นข้อความดิจิทัลที่คอมพิวเตอร์สามารถอ่าน, แก้ไข, ค้นหา หรือนำไปใช้ประมวลผลต่อได้
...
คือแอปพลิเคชันหรือโปรแกรมที่ทำงานบนอุปกรณ์ของผู้ใช้ เช่น มือถือ คอมพิวเตอร์ หรือแท็บเล็ต ในโครงงานนี้ \textbf{แอปพลิเคชันที่พัฒนาด้วย Flutter} และ \textbf{Dart} ทำหน้าที่เป็น Client ซึ่งทำงานบนอุปกรณ์ Android ของผู้ใช้ มีหน้าที่หลักดังนี้
\begin{enumerate}[leftmargin=2em]
...
\subsubsection{Server (ฝั่งเซิร์ฟเวอร์)}
    คือระบบที่ทำงานบนเครื่องแม่ข่าย มีหน้าที่รับคำขอจาก Client และประมวลผลตามคำขอนั้น ในโครงงานนี้ \textbf{Spring Boot Application} ทำหน้าที่เป็น Server ที่ให้บริการ REST API และเชื่อมต่อกับฐานข้อมูล PostgreSQL
     ได้แก่
\begin{enumerate}[leftmargin=2em]
...
\begin{enumerate}[leftmargin=2em]
    \item \textbf{การแยกหน้าที่ชัดเจน:}Client รับผิดชอบส่วนแสดงผล ขณะที่ Server จัดการข้อมูลและตรรกะทางธุรกิจ
