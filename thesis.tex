...
\newcommand{\thesisTitleTH}{แอปพลิเคชันสแกนยาและแจ้งเตือนการทานยา}

%Thesis Keywords
\newcommand{\thesisKeywords}
{Application \slash Framework \slash Cross-platform \slash API \slash Text-to-Speech \slash Notification \slash Optical Character Recognition - OCR \slash Frontend \slash Backend}
